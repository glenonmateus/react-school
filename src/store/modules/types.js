...
export const STORE_STUDENT_REQUEST = "STORE_STUDENT_REQUEST";
export const STORE_STUDENT_SUCCESS = "STORE_STUDENT_SUCCESS";
export const STORE_STUDENT_FAILURE = "STORE_STUDENT_FAILURE";
